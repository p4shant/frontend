...
import { CalendarCheck, LayoutDashboard, PanelsTopLeft, UserRound, Eye, FileText, UserPlus, BarChart3, CheckSquare, ClipboardPlus, Package, ArrowDownToLine, ArrowUpFromLine, History, Users, Gauge, Car, ShieldCheck, Shield, IndianRupee, CircleDollarSign, KeyRound } from 'lucide-react';
...
const MASTER_ADMIN_ITEMS = [
    ...
    { label: 'Reset Password', to: '/reset-employee-password', icon: <KeyRound size={18} /> },
];
...
const PAYMENT_COLLECTION_ITEM = { label: 'Payment Collection', to: '/payment-collection', icon: <IndianRupee size={18} /> };

const PAYMENT_APPROVAL_ITEM = { label: 'Payment Approval', to: '/payment-approval', icon: <CircleDollarSign size={18} /> };
...
function Sidebar({ state }: Props) {
    ...
    const isHelpDesk = user?.employee_role === 'Help Desk';
            ...
            : isStockController
                ...
                : isInventoryOperator
                    ...
                    : isQATester
                        ...
                        : [
                            ...NAV_ITEMS,
                            ...(isMasterAdmin ? [...MASTER_ADMIN_ITEMS, ADMIN_ATTENDANCE_ITEM, PAYMENT_APPROVAL_ITEM, TRAVEL_REVIEW_ITEM] : []),
