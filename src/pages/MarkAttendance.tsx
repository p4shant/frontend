                                        ...
                                        <div className="flex items-start gap-3">
                                            {todayStatus.punch_in_image_url && (
                                                <div className="flex-shrink-0">
                                                    <img
                                                        src={`${import.meta.env.VITE_API_BASE?.replace('/api', '') || 'http://srv1304976.hstgr.cloud:3000'}${todayStatus.punch_in_image_url}`}
                                                        alt="Punch In"
                                                        className="w-20 h-20 object-cover rounded-lg border-2 border-blue/30 cursor-pointer hover:opacity-80 transition"
                                                        onClick={() => {
                                                            const API_BASE = import.meta.env.VITE_API_BASE?.replace('/api', '') || 'http://srv1304976.hstgr.cloud:3000'
                                    ...
                                    <div className="mb-3 p-3 bg-purple/5 border border-purple/20 rounded-lg">
                                        <div className="flex items-start gap-3">
                                            {todayStatus.punch_out_image_url && (
                                                <div className="flex-shrink-0">
                                                    <img
                                                        src={`${import.meta.env.VITE_API_BASE?.replace('/api', '') || 'http://srv1304976.hstgr.cloud:3000'}${todayStatus.punch_out_image_url}`}
                                                        alt="Punch Out"
